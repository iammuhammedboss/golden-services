 ...
 * - Items can be at root level
 * - Items can be nested under properties, spaces, or other items
...
async function seedMeasurementCatalog() {
  ...
  const catalogItems = [
    ...
    // ============================================
    {
      ...
      unitId: pieceUnit.id,
      canBeRootLevel: true,
      allowedParentTypes: [...propertyTypes.map(String), ...spaceTypes.map(String), ...itemTypes.map(String)],
      allowedChildTypes: itemTypes.map(String),
  ...
  console.log('✓ Items can be at root level')
  console.log('✓ Items can be under properties, spaces, or other items')
  ...
  console.log('  • Sofa (at root level) ✓')
  console.log('  • Sofa → Chair (items can nest) ✓')
