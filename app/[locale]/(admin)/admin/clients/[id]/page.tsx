...
export default function ClientDetailsPage() {
  ...
  const actionTiles = [
    ...
    { label: 'Quotes', href: `/${locale}/admin/quotations?clientId=${id}`, color: 'from-orange-500 to-orange-600', icon: <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg> },
    { label: 'New Quote', href: `/${locale}/admin/quotations/new?clientId=${id}`, color: 'from-amber-500 to-amber-600', icon: <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4v16m8-8H4" /></svg> },
