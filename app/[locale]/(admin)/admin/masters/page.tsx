...
const masterTiles = [
  {
    title: 'Employees',
    description: 'Sales executives, cleaners, supervisors',
  ...
  {
    title: 'Equipment',
    description: 'Machinery & tools for jobs',
  ...
  {
    title: 'Units',
    description: 'Measurement units (sqm, piece, set)',
  ...
  {
    title: 'Room Types',
    description: 'Hall, bedroom, kitchen, etc.',
  ...
  },
  {
    ...
    description: 'Cash, transfer, credit options',
  ...
  {
    title: 'Services',
    description: 'Service categories & offerings',
  ...
  },
  {
    ...
    description: 'T&C templates for quotations',
  ...
  {
    title: 'Bank Details',
    description: 'Bank detail templates',
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5 pb-8">
      <div>
        ...
        <p className="text-xs text-gray-400">Manage reference data for dropdowns and settings</p>
      </div>
